...
(function (_) {
	...
	try {
		...
		(0, _._F_toggles_initialize)([0x8142400, 0x0]);
		...
		t('Promise', function (a) {
			...
			e.prototype.G = function (g) {
				if (g === this) this.l(new TypeError('h'));
					...
					if (n && fa(h[0], m))
						for (h = 0; h < n.length; h++) {
							...
							if ((k !== k && p.key !== p.key) || k === p.key)
								return { id: m, list: n, index: h, U: p };
						}
	...
	*/
		...
		_.Ab =
			_.w('Gecko') &&
			!(_.ua(_.qa().toLowerCase(), 'webkit') && !_.w('Edge')) &&
		...
		_.ab = function (a) {
			return a instanceof _.Xa && a.constructor === _.Xa
				? a.g
				: 'type_error:SafeUrl';
		};
		Ya = {};
		...
		_.Nb = function (a) {
			return a instanceof _.Mb && a.constructor === _.Mb
				? a.g
				: 'type_error:SafeHtml';
		};
		...
		ac.prototype.add = function (a, b, c, d, e) {
			...
			-1 < g
				? ((b = a[g]), c || (b.nb = !1))
				: ((b = new Zb(b, this.src, f, !!d, e)), (b.nb = c), a.push(b));
			return b;
		};
		...
		ac.prototype.Ua = function (a, b, c, d) {
			a = this.g[a.toString()];
			var e = -1;
			a && (e = bc(a, b, c, d));
			return -1 < e ? a[e] : null;
		...
		var bc = function (a, b, c, d) {
			for (var e = 0; e < a.length; ++e) {
				var f = a[e];
				if (!f.Ya && f.listener == b && f.capture == !!c && f.wa == d) return e;
			}
			return -1;
		};
		...
		oc = function (a, b, c, d, e) {
			if (Array.isArray(b))
				...
				(d = _.ib(d) ? !!d.capture : !!d),
					...
					_.Xb(a)
						? a.Da(b, c, d, e)
						: a && (a = _.kc(a)) && (b = a.Ua(b, c, d, e)) && _.pc(b);
		};
		_.pc = function (a) {
			if ('number' === typeof a || !a || a.Ya) return !1;
			var b = a.src;
			if (_.Xb(b)) return cc(b.ga, a);
			var c = a.type,
				d = a.proxy;
		...
		_.rc.prototype.Ua = function (a, b, c, d) {
			return this.ga.Ua(String(a), b, c, d);
		};
		var tc = function () {};
		tc.prototype.g = null;
		var vc;
		...
		_.Tc = function (a) {
			var b = Ac(a);
			if ('undefined' == typeof b) throw Error('C');
			var c = new Hc(null);
			a = zc(a);
	...
	try {
		...
		_.l.remove = function (a, b, c) {
			...
			this.set(a, '', { Ub: 0, path: b, domain: c });
			return d;
		};
		_.l.Ta = function () {
			return ed(this).keys;
	...
	try {
		...
		_.jd = function (a) {
			switch (_.H(a, 1)) {
				...
				case 7:
					...
					break;
				case 8:
					_.z('Parameter ' + _.I(a, 2) + ' is not set correctly.');
					break;
				case 9:
		...
		_.Cd = function (a) {
			if ('string' === typeof a) return { buffer: vd(a), za: !1 };
			if (Array.isArray(a)) return { buffer: new Uint8Array(a), za: !1 };
			if (a.constructor === Uint8Array) return { buffer: a, za: !1 };
			if (a.constructor === ArrayBuffer)
				return { buffer: new Uint8Array(a), za: !1 };
			if (a.constructor === _.Ad) return { buffer: _.Bd(a) || _.zd(), za: !0 };
		...
		_.Wd = function (a, b, c) {
			if (null != a && 'object' === typeof a && a.tb === Vd) return a;
			if (Array.isArray(a)) {
				var d = (0, _.Md)(a),
					e = d;
				0 === e && (e |= c & 32);
		...
		_.J = function (a, b, c) {
			...
			if (null == a) {
				...
				d = (0, _.Md)(a);
				if (d & 2048) throw Error('V');
				if (d & 64) return a;
				d |= 64;
				if (c && ((d |= 512), c !== a[0])) throw Error('W');
				a: {
					c = a;
					var e = c.length;
					if (e) {
		...
		_.be = function (a) {
			switch (typeof a) {
				...
				case 'object':
					if (a)
						if (Array.isArray(a)) {
							if (Nd(a, void 0, 0)) return;
						} else {
							if (_.xd(a)) return qd(a);
		...
		fe = function (a) {
			return a.tb === Vd ? a.toJSON() : _.be(a);
		};
		ge = function (a, b, c) {
			c = void 0 === c ? Hd : c;
			if (null != a) {
				if (wd && a instanceof Uint8Array) return b ? a : new Uint8Array(a);
				if (Array.isArray(a)) {
					var d = (0, _.Md)(a);
					if (d & 2) return a;
		...
		pe = function (a, b, c) {
			...
			if (Ld((c = b[a - 1]))) {
				a: {
					...
					for (m in g) {
						...
						if (Array.isArray(n)) {
							var p = n;
							if (Nd(n, d, +m) || (Kd(n) && 0 === n.size)) n = null;
							n != p && (k = !0);
						}
						null != n ? (h[m] = n) : (k = !0);
					}
			...
			for (m = +!!(e & 512) - 1; 0 < a; a--) {
				...
				c = b[r];
				r -= m;
				if (!(null == c || Nd(c, d, r) || (Kd(c) && 0 === c.size))) break;
				var q = !0;
			}
			if (!f && !q) return b;
		...
		_.Be = function (a, b, c, d, e) {
			a.v(
				c,
				b instanceof _.L ? b.A : Array.isArray(b) ? _.J(b, d[0], d[1]) : void 0,
				e
			);
		};
		_.Ce = function (a) {
			return function (b) {
				if (null == b || '' == b) b = new a();
					...
					b = JSON.parse(b);
					if (!Array.isArray(b)) throw Error('Z');
					(0, _.ie)(b, 32);
					b = _.Yd(a, b);
				}
				return b;
		...
		Ie = function (a) {
			...
			a.vb && (_.v.clearTimeout(a.vb), (a.vb = null));
		};
		Je = function (a) {
		...
		Ke = function (a) {
			a.Mb ||
				((a.Mb = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'));
		};
		Le = function (a, b) {
			if (a.C) {
				Ie(a);
				var c = a.C,
					d = a.xb[0] ? function () {} : null;
				a.C = null;
				a.xb = null;
		...
		Pe = function (a) {
			if (
				a.ma &&
				'undefined' != typeof _.db &&
				(!a.xb[1] || 4 != Ne(a) || 2 != a.pb())
			)
				if (a.rb && 4 == Ne(a)) Ee(a.Oc, 0, a);
		...
		Re = function (a) {
			...
			this.xb = this.C = null;
			this.Sb = '';
			this.ya = this.Pb = this.rb = this.Mb = !1;
			this.wb = 0;
			this.vb = null;
			this.Tc = '';
			this.bc = this.Td = this.cc = !1;
		...
		_.l.send = function (a, b, c, d) {
			if (this.C) throw Error('y`' + this.Sb + '`' + a);
			b = b ? b.toUpperCase() : 'GET';
			this.Sb = a;
			this.Mb = !1;
			this.ma = !0;
			this.C = new XMLHttpRequest();
			this.xb = this.Wc ? De(this.Wc) : De(_.uc);
			this.C.onreadystatechange = (0, _.lb)(this.Oc, this);
			this.Td &&
				'onprogress' in this.C &&
				((this.C.onprogress = (0, _.lb)(function (g) {
					this.Nc(g, !0);
				}, this)),
				this.C.upload && (this.C.upload.onprogress = (0, _.lb)(this.Nc, this)));
			try {
				(this.Pb = !0), this.C.open(b, String(a), !0), (this.Pb = !1);
			} catch (g) {
				Me(this);
				return;
			}
			...
			'withCredentials' in this.C &&
				this.C.withCredentials !== this.cc &&
				(this.C.withCredentials = this.cc);
			...
			try {
				Ie(this),
					0 < this.wb &&
						((this.bc = Je(this.C))
							? ((this.C.timeout = this.wb),
							  (this.C.ontimeout = (0, _.lb)(this.Vc, this)))
							: (this.vb = Ee(this.Vc, this.wb, this))),
					(this.rb = !0),
					this.C.send(a),
					(this.rb = !1);
			} catch (g) {
		...
		_.l.ea = function () {
			this.C &&
				(this.ma &&
					((this.ma = !1), (this.ya = !0), this.C.abort(), (this.ya = !1)),
				Le(this, !0));
			Re.ra.ea.call(this);
		};
		_.l.Oc = function () {
			this.Hc() || (this.Pb || this.rb || this.ya ? Pe(this) : this.Sd());
		};
		_.l.Sd = function () {
			Pe(this);
		};
		...
		_.l.pb = function () {
			try {
				return 2 < Ne(this) ? this.C.status : -1;
			} catch (a) {
				return -1;
			}
		};
		_.l.getResponseHeader = function (a) {
			if (this.C && 4 == Ne(this))
				return (a = this.C.getResponseHeader(a)), null === a ? void 0 : a;
		};
		_.l.getAllResponseHeaders = function () {
			return this.C && 2 <= Ne(this)
				? this.C.getAllResponseHeaders() || ''
				: '';
		};
		_.Se = function (a) {
			try {
		...
		We = function (a, b) {
			...
			void 0 === Ue && (_.v.Int32Array ? (Ue = new Int32Array(Ve)) : (Ue = Ve));
			this.reset();
		};
		_.mb(We, Te);
		...
		We.prototype.digest = function () {
			var a = [],
				b = 8 * this.j;
			56 > this.h
				? this.update(_.Kb, 56 - this.h)
				: this.update(_.Kb, this.blockSize - (this.h - 56));
		...
		_.af = 'undefined' !== typeof TextDecoder;
		_.bf = 'function' === typeof String.prototype.Fd;
		_.cf = 'undefined' !== typeof TextEncoder;
		var df, ef, td, gf, ff;
		df = {};
		ef = null;
		_.pd = function (a, b) {
			...
			function c(k) {
				for (; d < a.length; ) {
					var m = a.charAt(d++),
						n = ef[m];
					if (null != n) return n;
					if (!/^[\s\xa0]*$/.test(m)) throw Error('H`' + m);
				}
				return k;
			}
			ff();
		...
		_.hf = {};
		_.Ad = function (a, b) {
			if (b !== _.hf) throw Error('I');
			this.g = a;
			if (null != a && 0 === a.length) throw Error('J');
		};
		_.Ad.prototype.sb = function () {
			return null == this.g;
		};
		_.Bd = function (a) {
			if (_.hf !== _.hf) throw Error('I');
			var b = a.g;
			b = null == b || _.xd(b) ? b : 'string' === typeof b ? vd(b) : null;
			return null == b ? b : (a.g = b);
		};
		_.jf = 'function' === typeof Uint8Array.prototype.slice;
		...
		_.me = function (a, b, c, d) {
			...
			if (c >= e) {
				...
				if (d && b & 256 && ((d = a[f - 1][c]), null != d)) {
					if (ke(a, b, e, c) && null != lf) {
						var g;
						a = null != (g = rf) ? g : (rf = {});
						g = a[lf] || 0;
						4 <= g ||
							((a[lf] = g + 1), (g = Error()), Rd(g, 'incident'), _.gd(g));
					}
					return d;
				}
				return ke(a, b, e, c);
		...
		uf = function (a, b, c, d) {
			...
			var f = _.me(a, e, c, d),
				g;
			if (null != f && f.tb === Vd)
				return (b = _.je(f)), b !== f && _.le(a, e, c, b, d), b.A;
			if (Array.isArray(f)) {
				var h = (0, _.Md)(f);
				h & 2 ? (g = _.he(f, h, !1)) : (g = f);
				g = _.J(g, b[0], b[1]);
			} else g = _.J(void 0, b[0], b[1]);
			g !== f && _.le(a, e, c, g, d);
			return g;
		};
		...
		_.xf = function (a, b, c) {
			if (null != c) {
				if ('number' !== typeof c) throw _.Sd('int32');
				if (!Number.isFinite(c)) throw _.Sd('int32');
				c |= 0;
			}
			return _.sf(a, b, c);
		};
		...
		_.R = function (a, b, c) {
			if (null != c) {
				if (!Number.isFinite(c)) throw _.Sd('enum');
				c |= 0;
			}
			return _.sf(a, b, c);
		};
		...
		_.L.prototype.toJSON = function () {
			return _.nf
				? pe(this, this.A, !1)
				: pe(this, de(this.A, fe, void 0, void 0, !1), !0);
		};
		_.L.prototype.za = function () {
			return !!((0, _.Md)(this.A) & 2);
		};
		_.L.prototype.tb = Vd;
	...
	try {
	 ...
	 SPDX-License-Identifier: Apache-2.0
	*/
		var ui, Ci, Di, Ei, Fi, Gi, Hi, Ii, Ji, Ki, Ni, wi, Oi;
		_.mi = function (a) {
		...
		_.ni = function (a) {
			if (!a.startsWith(")]}'\n"))
				throw (console.error('malformed JSON response:', a), Error('aa'));
			a = a.substring(5);
			return JSON.parse(a);
		};
		_.oi = function (a) {
					...
					case 0:
						...
						if (0 > m) {
							...
							c.push(a.substring(k, m)),
								...
								(k = m + 1),
								si
									? ((ti.lastIndex = k), (m = ti.exec(a)))
									: ((ti.lastIndex = 0), (m = ti.exec(a.substring(k)))),
								m
									? ((f = ['<', m[0]]), (g = m[1]), (e = 1), (k += m[0].length))
									: c.push('<');
						break;
					case 1:
						m = a.charAt(k++);
						switch (m) {
							...
							case '"':
								...
								0 > n
									? (k = d)
									: (f.push(m, a.substring(k, n + 1)), (k = n + 1));
								break;
							case '>':
								f.push(m);
								c.push(b(f.join(''), g));
		...
		_.Mi = function (a) {
			return a instanceof _.Li && a.constructor === _.Li
				? a.g
		...
		Xi.prototype.xc = null;
		Xi.prototype.toString = function () {
			return this.Ab;
		};
		Xi.prototype.g = function () {
			if (this.Hb !== _.Ui) throw Error('fa');
			return Ni(this.toString());
		};
		var Yi = function () {
			Xi.call(this);
		};
		_.mb(Yi, Xi);
		Yi.prototype.Hb = _.Ui;
		_.Zi = function (a, b) {
			return null != a && a.Hb === b;
		};
		var dj, si, ti, kj, bj, lj, aj, mj, gj, cj;
		_.$i = function (a) {
			if (null != a)
				switch (a.xc) {
					case 1:
		...
		_.W = function (a) {
			return _.Zi(a, _.Ui)
				? a
				: a instanceof _.Mb
				? (0, _.V)(_.Nb(a).toString())
				: (0, _.V)(String(String(a)).replace(aj, bj), _.$i(a));
		};
		_.V = (function (a) {
			function b(c) {
				this.Ab = c;
		...
		dj = function (a) {
			return ui(String(a), function () {
				return '';
			}).replace(cj, '&lt;');
		};
		si = RegExp.prototype.hasOwnProperty('sticky');
		ti = new RegExp(
			(si ? '' : '^') + '(?:!|/?([a-zA-Z][a-zA-Z0-9:-]*))',
			si ? 'gy' : 'g'
		);
		_.X = function (a) {
			return _.Zi(a, _.Ui) ? _.ej(dj(a.Ab)) : String(a).replace(aj, bj);
		};
		_.jj = function (a) {
			_.Zi(a, _.Vi) || _.Zi(a, _.Wi)
				? (a = _.fj(a))
				: a instanceof _.Xa
				? (a = _.fj(_.ab(a)))
				: a instanceof _.Li
				? (a = _.fj(_.Mi(a).toString()))
				: ((a = String(a)),
				  (a = gj.test(a) ? a.replace(_.hj, _.ij) : 'about:invalid#zSoyz'));
			return a;
		};
		kj = {
			'\x00': '&#0;',
		...
		mj = /[\x00\x22\x27\x3c\x3e]/g;
		_.hj =
			/[\x00- \x22\x27-\x29\x3c\x3e\\\x7b\x7d\x7f\x85\xa0\u2028\u2029\uff01\uff03\uff04\uff06-\uff0c\uff0f\uff1a\uff1b\uff1d\uff1f\uff20\uff3b\uff3d]/g;
		gj =
			/^[^&:\/?#]*(?:[\/?#]|$)|^https?:|^ftp:|^data:image\/[a-z0-9+-]+;base64,[a-z0-9+\/]+=*$|^blob:/i;
		_.ej = function (a) {
			return String(a).replace(mj, bj);
		};
		_.fj = function (a) {
			return String(a).replace(_.hj, _.ij);
		};
		cj = /</g;
		_.nj = '0'.codePointAt(0);
		_.oj = RegExp("'([{}#].*?)'", 'g');
		_.pj = RegExp("''", 'g');
		var vi = {};
		_.qj = function (a) {
		...
		_.rj = function (a) {
			return (0, _.V)(
				(a
					...
					: '<svg class="' +
					  _.X('fFW7wc-ibnC6b-HiaYvf') +
					  ' ' +
					  _.X('zTETae-mzNpsf-Bz112c') +
					  ' ' +
					  _.X('n1UuX-DkfjY') +
					  '" aria-hidden=true viewBox="0 0 192 192">') +
	...
	try {
		...
		_.vj = function (a, b, c) {
			...
			if (b && 2 === _.H(b, 7)) {
				...
				b && 2 === _.H(b, 10) && !_.U('disable_personalized_button')
					? ((c = void 0 === c ? !0 : c),
					  b && _.tf(b, _.Ti, 8)
							? ((d = {}),
							  b &&
		...
		var zj = function (a, b) {
			...
			Dj = function (a) {
				_.Zi(a, Aj)
					...
					: a instanceof xj
					? (a = Bj(
							a instanceof xj && a.constructor === xj
								? a.g
								: 'type_error:SafeStyle'
					  ))
					: a instanceof yj
					? (a = Bj(
							a instanceof yj && a.constructor === yj
								? a.g
								: 'type_error:SafeStyleSheet'
					  ))
					: ((a = String(a)), (a = Cj.test(a) ? a : 'zSoyz'));
				return a;
			},
			Ej = function () {
				return (0, _.V)(
		...
		var Kj = function (a, b, c, d, e, f, g, h) {
				var k = void 0 === g ? !0 : g;
				h = void 0 === h ? !1 : h;
				g = e && 1 !== e ? _.W(Gj(e)) : _.W(Gj(2));
				var m = _.V;
				k =
					'<div' +
					(k ? ' tabindex="0"' : '') +
					' role="button" aria-labelledby="button-label" class="' +
					_.X('nsm7Bb-HzV7m-LgbsSe') +
					' ' +
					(h ? _.X('Bz112c-LgbsSe') : '') +
					' ';
				var n = '';
				...
				return m(
					k +
						...
						(f && !h
							...
							: '') +
						'><div class="' +
						_.X('nsm7Bb-HzV7m-LgbsSe-MJoBVe') +
						'"></div><div class="' +
						_.X('nsm7Bb-HzV7m-LgbsSe-bN97Pc-sM5MNb') +
						' ' +
						(2 === a ? _.X('oXtfBe-l4eHX') : '') +
						'">' +
						Jj(2 === c || 3 === c) +
						(h
							? ''
							: '<span class="' +
							  _.X('nsm7Bb-HzV7m-LgbsSe-BPrWId') +
							  '">' +
							  _.W(Gj(e)) +
							  '</span>') +
						'<span class="' +
			...
			Jj = function (a) {
				return (0, _.V)(
					(void 0 === a ? 0 : a)
						? '<div class="' +
								_.X('nsm7Bb-HzV7m-LgbsSe-Bz112c-haAclf') +
								'"><div class="' +
								_.X('nsm7Bb-HzV7m-LgbsSe-Bz112c') +
								'">' +
								Ej() +
								'</div></div>'
						: '<div class="' +
	...
	try {
		...
		_.nk = function () {
			return ![_.Da() && !_.lk() && !_.mk(), _.Da() && _.jk(), _.Aa()].some(
				function (a) {
					return a;
				}
			);
	...
	try {
		...
		_.mb(_.Qm, _.rc);
		_.Qm.prototype.h = !1;
		_.Qm.prototype.g = null;
		_.Qm.prototype.I = function () {
			if (this.h) {
				var a = Date.now() - this.B;
				0 < a && a < 0.8 * this.j
					? (this.g = this.i.setTimeout(this.v, this.j - a))
					: (this.g && (this.i.clearTimeout(this.g), (this.g = null)),
					  this.dispatchEvent('tick'),
					  this.h && (_.Rm(this), this.start()));
			}
		};
		_.Qm.prototype.start = function () {
			this.h = !0;
			this.g ||
				((this.g = this.i.setTimeout(this.v, this.j)), (this.B = Date.now()));
		};
		_.Rm = function (a) {
			a.h = !1;
		...
		_.mb(_.Sm, _.Rb);
		var Tm = [];
		_.Sm.prototype.L = function (a, b, c, d) {
			Array.isArray(b) || (b && (Tm[0] = b.toString()), (b = Tm));
		...
		_.Sm.prototype.Tb = function (a, b, c, d) {
			return Um(this, a, b, c, d);
		};
		var Um = function (a, b, c, d, e, f) {
			if (Array.isArray(c))
				for (var g = 0; g < c.length; g++) Um(a, b, c[g], d, e, f);
			else {
		...
		_.Sm.prototype.Da = function (a, b, c, d, e) {
			if (Array.isArray(b))
		...
		_.Sm.prototype.ea = function () {
			_.Sm.ra.ea.call(this);
			Vm(this);
		};
		_.Sm.prototype.handleEvent = function () {
			throw Error('Aa');
		};
	} catch (e) {
		_._DumpException(e);
	...
	try {
		...
		_.vn.prototype.toString = function () {
			return this.g;
		};
	} catch (e) {
		_._DumpException(e);
	...
	try {
		...
		_.M(_.Bo, _.L);
		_.Co = [0, _.Af, -1, _.Bf, _.Af, -2, _.Bf, _.Af];
	} catch (e) {
		_._DumpException(e);
	}
	try {
		...
		Oo = !_.yb && !_.Ea();
		_.Po = function (a) {
			if (Oo && a.dataset) return a.dataset;
			var b = {};
			a = a.attributes;
			for (var c = 0; c < a.length; ++c) {
				var d = a[c];
				if (0 == d.name.lastIndexOf('data-', 0)) {
					var e = _.Mo(d.name.slice(5));
					b[e] = d.value;
				}
			}
			return b;
		...
		_.Ro = (function () {
			...
			if (_.bd) {
				...
				return Qo(/Chrome\/([0-9.]+)/);
			}
			if (_.cd && !_.Ia()) return Qo(/Version\/([0-9.]+)/);
			if (_.Zc || _.$c) {
				if ((a = /Version\/(\S+).*Mobile\/(\S+)/.exec(_.qa())))
					return a[1] + '.' + a[2];
			} else if (_.ad)
				return (a = Qo(/Android\s+([0-9.]+)/)) ? a : Qo(/Version\/([0-9.]+)/);
			return '';
		})();
	} catch (e) {
		_._DumpException(e);
	...
	try {
		...
		Xo = function (a) {
			...
			if ('string' === typeof a) return cp(a);
			if (Array.isArray(a)) {
				for (var b = 0; b < a.length; b++)
					if ('string' !== typeof a[b] || !cp(a[b])) return !1;
				return !0;
			}
			return !1;
		};
		cp = function (a) {
			try {
				...
				a = c;
				b = 'Rb';
				if (dp.Rb && dp.hasOwnProperty(b)) var d = dp.Rb;
				else {
					var e = new dp();
					d = dp.Rb = e;
				}
		...
		Zo = function () {
			fp ||
				(fp = _.C(window, 'message', function (a) {
					a = a.g;
					if (a.data) {
						var b = a.data;
		...
		_.jp = function (a) {
			_.Uo
				? _.Vo({ command: 'intermediate_iframe_resize', height: a })
				: _.y(
		...
		_.kp = function () {
			_.Uo
				? _.Vo({ command: 'intermediate_iframe_close' })
				: _.y(
		...
		_.lp = function (a) {
			_.Uo
				? _.Vo({ command: 'set_tap_outside_mode', cancel: a })
				: _.y(
		...
		var np = function (a, b, c, d) {
			...
			if (d && void 0 !== a.g) throw Error('Ba`' + b);
			a.g = c;
		};
		...
		var pp = function (a, b, c) {
			void 0 !== a.g && c.push(b);
			for (var d in a.P) pp(a.P[d], b + d, c);
		};
		...
		mp.prototype.remove = function (a) {
			for (var b = this, c = [], d = 0; d < a.length; d++) {
				var e = a.charAt(d);
				if (!b.P[e]) throw Error('Ca`' + a);
				c.push([b, e]);
				b = b.P[e];
			}
			a = b.g;
			for (delete b.g; 0 < c.length; )
				if (((e = c.pop()), (b = e[0]), (e = e[1]), b.P[e].sb())) delete b.P[e];
				else break;
			return a;
		};
		...
		var dp = function () {
			...
			rp = function (a, b, c, d) {
				...
				a++;
				if ('?' == e || ',' == e) return a;
				do (a = rp(a, b, c, d)), (e = c.charAt(a));
				while ('?' != e && ',' != e);
				return a + 1;
			};
		var Yo, fp, Wo, $o, ap;
		_.A('google.accounts.id.intermediate.verifyParentOrigin', _.bp);
		_.A('google.accounts.id.intermediate.notifyParentResize', _.jp);
		_.A('google.accounts.id.intermediate.notifyParentClose', _.kp);
		_.A('google.accounts.id.intermediate.notifyParentDone', function () {
			_.Uo
				? _.Vo({ command: 'intermediate_iframe_done' })
				: _.y(
						'Done command was not sent due to missing verified parent origin.'
				  );
		});
		_.A('google.accounts.id.intermediate.notifyParentTapOutsideMode', _.lp);
	} catch (e) {
		_._DumpException(e);
	}
	try {
		var sp = function (a, b) {
			...
			Cp = function (a, b) {
				...
				return function (f, g, h) {
					return e(f, g, h, d || (d = zp(b).La), c || (c = Bp(b)));
				};
			},
			zp = function (a) {
				var b = a[_.ye];
				if (b) return b;
				b = _.ve(a, (a[_.ye] = {}), yp, Cp);
				_.ze(a);
				return b;
			},
			Dp = function (a, b) {
			...
			Ap = function (a, b, c) {
				...
				if (d & 256) {
					...
					for (var p in d)
						(e = +p),
							Number.isNaN(e) ||
								((f = d[p]), null != f && (g = Dp(c, e)) && g(b, f, e));
				}
				if ((a = _.Pd ? a[_.Pd] : void 0))
					for (Ep(b, b.g.end()), c = 0; c < a.length; c++)
						Ep(b, _.Bd(a[c]) || _.zd());
			},
			Fp = function (a, b) {
				var c = [];
			...
			Ip = function () {
				var a = _.To().toString(),
					b = { Ub: 300, path: '/', Zb: !0 },
					c;
				if ((c = _.Da())) c = 0 <= _.ok(_.Ro, 80);
				c && (b.Yb = 'none');
				c = _.Pc(location.origin);
				'http' === c.h &&
					'localhost' === c.g &&
					((b.Zb = void 0), (b.Yb = void 0));
				_.fd.set('g_csrf_token', a, b);
				return a;
			},
			Mp = function (a, b, c) {
				Jp = a ? a + '/gsi/log' : 'https://accounts.google.com/gsi/log';
				Kp = b;
				Lp = c;
			},
			Op = function (a, b) {
				Np >= (void 0 === b ? 100 : b) ||
					((b = new _.Bc(Jp)),
					_.Ec(b, _.Tc({ client_id: Kp, as: Lp, event: a.toString() })),
					_.$e(
						b.toString(),
						void 0,
						'POST',
						...
						void 0,
						void 0,
						'https://accounts.google.com/gsi/log' !== Jp
					));
			},
			Sp = function (a) {
				var b = new (Function.prototype.bind.apply(
					Pp,
					[null, 'onetap', a, 'prompt'].concat(Qp(Rp.apply(1, arguments)))
				))();
				Op(b);
			},
			Tp = function () {
				var a = new (Function.prototype.bind.apply(
					Pp,
					[null, 'onetap', void 0, 'closed'].concat(Qp(Rp.apply(0, arguments)))
				))();
				Op(a);
			},
			Up = function () {
				var a = new (Function.prototype.bind.apply(
					Pp,
					[null, 'id', void 0, 'init'].concat(Qp(Rp.apply(0, arguments)))
				))();
				Op(a);
			},
			Vp = function () {
				var a = new (Function.prototype.bind.apply(
					Pp,
					[null, 'onetap', void 0, 'policy'].concat(Qp(Rp.apply(0, arguments)))
				))();
				Op(a);
			},
			Yp = function (a) {
				var b = void 0 === b ? 'googleidentityservice' : b;
				if (!(document.getElementById(b) && Wp.get(b) && Wp.get(b))) {
					var c = new _.Ef(),
			...
			hq = function (a, b, c) {
				...
				_.$e(b.toString(), void 0, 'POST', void 0, void 0, void 0, e !== d);
			},
			iq = function (a, b, c) {
				if (
				...
				if (a) {
					...
					if ((d = a.login_uri)) {
						...
						if ('https' !== b.h && 'localhost' !== b.g)
							throw (
								(Up('unsecuredLoginUri', d),
								new mq('Unsecured login_uri provided.'))
							);
						d = b.toString();
						a.login_uri = d;
					}
					d && !a.callback && (a.callback = nq(d, c));
					'redirect' !== a.ux_mode ||
						d ||
				...
				return function (c) {
					c && c.credential
						? ((b.credential = c.credential),
						  (b.g_csrf_token = Ip()),
						  _.nd(a, b))
						: _.G('No credential found in the response.');
				};
			},
			oq = function (a, b, c, d) {
				return function (e) {
					e && 'password' === e.type
						? ((b[c] = e.id), (b[d] = e.password), _.nd(a, b))
						: _.G('No password credential returned.');
				};
			},
			rq = function (a) {
				a = _.Po(a);
			...
			xq = function (a, b, c) {
				var d = tq.__G_ID_CLIENT__;
				d || (wq(), (d = tq.__G_ID_CLIENT__));
				d.sa(a, b, c);
			},
			zq = function (a, b, c) {
				if (a && b) {
			...
			Bq = function () {
				var a = tq.__G_ID_CLIENT__;
				a || (wq(), (a = tq.__G_ID_CLIENT__));
				Aq(a.D);
			},
			Cq = function () {
				var a = void 0 === a ? document.readyState : a;
				for (var b = _.Pi('g_id_signout'), c = 0; c < b.length; c++)
					_.C(b[c], 'click', Bq);
				try {
					var d = pq();
					if (d) {
			...
			Gq = function (a, b, c) {
				...
				Fq(c, 'access_type', g);
				Fq(c, 'hd', n);
				Fq(c, 'response_type', f);
				Fq(c, 'include_granted_scopes', !1 === p ? 'false' : 'true');
				Fq(c, 'enable_granular_consent', !1 === r ? 'false' : 'true');
				return b + '?' + c.join('&');
			},
			Iq = function (a, b) {
				if (!b.client_id)
			...
			Kq = function (a) {
				return (a = a && a.scope && a.scope.trim())
					? Jq.apply(null, Qp(a.split(' ')))
					: null;
			},
			Lq = function (a) {
				_.Ai(a, 'prompt_closed', { qe: !1 });
			},
			Mq = function (a, b, c) {
				b = { re: b };
				void 0 !== c && (b.se = c);
				_.Ai(a, 'prompt_resized', b);
			},
			Qp = function (a) {
		...
		var Nq = /^[\w+/_-]+[=]{0,2}$/,
			Xp = function (a, b) {
				...
				if (_.ua('', 'stylesheet')) {
					...
					b instanceof _.Li
						? (b = _.Mi(b).toString())
						: ((b = _.cb(b)), (b = void 0 === b ? _.Za.toString() : b)),
						(a.href = b);
			},
			eq = function (a, b) {
		...
		Qq.prototype.length = function () {
			return this.g.length;
		};
		Qq.prototype.end = function () {
			var a = this.g;
			this.g = [];
			return a;
		};
		...
		Tq.prototype.o = function (a, b) {
			null != b && null != b && (Rq(this.g, 8 * a), Sq(this.g, b));
		};
		Tq.prototype.l = function (a, b) {
			null != b && (Rq(this.g, 8 * a), this.g.g.push(b ? 1 : 0));
		};
		Tq.prototype.m = function (a, b) {
			null != b && ((b = parseInt(b, 10)), Rq(this.g, 8 * a), Sq(this.g, b));
		};
		Tq.prototype.j = function (a, b) {
			if (null != b) {
				var c = !1;
				c = void 0 === c ? !1 : c;
				if (_.cf) {
					if (
						...
						throw Error('G');
					b = (Pq || (Pq = new TextEncoder())).encode(b);
				} else {
					for (
		...
		var Vq = _.Ae(
				...
				function (a, b, c) {
					b =
						null == b || 'string' == typeof b || _.xd(b) || b instanceof _.Ad
							? b
							: void 0;
					null != b && Uq(a, c, _.Cd(b).buffer);
				}
			),
			Wq = { ke: 'signin', le: 'signup', ne: 'use' },
			Xq = { ge: 'card', fe: 'bottom_sheet' },
			Yq = {
				'402150438060-mvb4nhmp3o8rh83452qqlqq8bch09bnt.apps.googleusercontent.com':
			...
			Hq = function (a, b) {
				...
				Object.setPrototypeOf(this, Hq.prototype);
				this.type = b || 'unknown';
			};
		_.M(Hq, Error);
		var $q = function (a) {
		...
		Pp.prototype.toString = function () {
			...
			this.h && a.push.apply(a, Qp(this.h));
			return a.join('.');
		};
		var Np = Math.floor(100 * Math.random()),
			Jp = 'https://accounts.google.com/gsi/log',
			Kp,
			Lp;
		var Wp = new Map();
		var fr = function () {
			...
			gr = function (a, b, c) {
				...
				var d = { url: b.Ec, configURL: b.Dc, clientId: b.u.client_id };
				b.u.nonce && (d.nonce = b.u.nonce);
				b.u.hint && (d.loginHint = b.u.hint);
				_.U('enable_fedcm_domain_hint') &&
					b.u.hosted_domain &&
					(d.domainHint =
						'*' === b.u.hosted_domain ? 'any' : b.u.hosted_domain);
				d = { context: b.u.context || 'signin', providers: [d], mode: c };
				var e = { signal: a.h.signal, federated: d, identity: d };
				'widget' === c &&
					((e.mediation = b.Qa ? 'optional' : 'required'),
					(d.autoReauthn = !!b.Qa));
				'button' === c && (e.mediation = b.Lb ? 'optional' : 'required');
				_.x('FedCM options generated. callId: ' + a.g + '. ' + e);
				return e;
			};
		fr.prototype.pa = function (a, b, c) {
			c
				? (_.x('Processing FedCM response. callId ' + this.g),
				  c.login
						? c.login({ signal: this.h.signal, nonce: a.u.nonce }).then(
								function (d) {
									a.pa(b, d);
								},
								function (d) {
						...
						: a.pa(b, c))
				: (_.x('FedCM credential is null. callId ' + this.g),
				  a.Aa(b, Error('Da')));
		};
		var ir = function () {
				this.h = !1;
		...
		var mr = { left: 1, center: 2 },
			nr = { rectangular: 1, square: 3, pill: 2, circle: 4 },
			or = { large: 1, medium: 2, small: 3 },
			pr = { signin: 1, signin_with: 2, signup_with: 3, continue_with: 4 },
			qr = { outline: 1, filled_blue: 2, filled_black: 3 },
			rr = { standard: 1, icon: 2 },
			sr = function (a, b, c) {
				this.s = a;
				this.h = c;
				this.g = !1;
				...
				if (
					b &&
					(b.logo_alignment && _.R(a, 6, mr[b.logo_alignment]),
					b.shape && _.R(a, 3, nr[b.shape]),
					b.size && _.R(a, 1, or[b.size]),
					b.text && _.R(a, 5, pr[b.text]),
					b.theme && _.R(a, 2, qr[b.theme]),
					b.type && _.R(a, 7, rr[b.type]),
					b.width)
				)
					if ('number' === typeof b.width && !isNaN(b.width))
						_.xf(a, 4, Number(b.width));
					else if ('string' === typeof b.width)
						try {
							var d = b.width;
							_.xf(a, 4, Number(d.endsWith('px') ? d.slice(0, -2) : d));
						} catch (e) {
			...
			tr = function (a) {
				if (!a.g) {
					_.vj(a.s, a.Ia);
					var b = _.Qi('nsm7Bb-HzV7m-LgbsSe', a.s);
					b &&
						a.h &&
						Fp(b, function () {
							a.h && a.h.call(a);
		...
		sr.prototype.V = function () {
			if (!this.g) {
				var a = _.Qi('nsm7Bb-HzV7m-LgbsSe', this.s);
				a && _.Si(a);
				this.g = !0;
		...
		var vr = [0, 7200, 86400, 604800, 2419200],
			wr = function (a, b, c) {
				this.i = a;
		...
		var Dr = { done: !0, value: void 0 };
		Cr.prototype.Ha = function () {
			return this;
		};
		var Hr = function (a) {
				if (a instanceof Er || a instanceof Fr || a instanceof Gr) return a;
		...
		var Lr = function (a) {
				if (null == a.g) throw Error('Fa');
				var b;
				(null != (b = a.h) ? b : (a.h = Mr(a.g))) || _.gd(Error('Fa'));
			},
			Mr = function (a) {
				if (!a) return !1;
				try {
		...
		var Pr = new _.vn('g_credential_picker'),
			Rr = function (a, b) {
				b = void 0 === b ? 'i_' : b;
				var c = new Nr();
				this.N = (c.h = Mr(c.g)) ? new Or(c, 'g_state_id_') : null;
				this.Hd = b;
				...
				this.l = btoa(String.fromCharCode.apply(String, Qp(b))).replace(
					/=+$/,
					''
				);
				this.I = new Map();
				this.oc = !1;
				this.G = new ir();
				this.jb = this.Z = this.ib = this.J = !1;
				Qr(this, a);
			};
		_.M(Rr, _.Df);
		var Qr = function (a, b) {
			...
			if (c) Sr(a, c);
				...
				if ((c = void 0 !== b.log_level))
					(c = b.log_level), (c = void 0 === c || 0 <= (0, _.La)(Oq, c));
				c && Sr(a, b.log_level);
			}
			a.Cd = b.button_url || 'https://accounts.google.com/gsi/button';
			a.Ac = b.picker_url || 'https://accounts.google.com/gsi/select';
			a.Jd = b.prompt_url || 'https://accounts.google.com/gsi/iframe/select';
			a.Fc = b.status_url || 'https://accounts.google.com/gsi/status';
			a.B = _.No(a.Fc);
			a.Gd = b.container_css_url || 'https://accounts.google.com/gsi/style';
			a.Ld = b.revoke_url || 'https://accounts.google.com/gsi/revoke';
			a.fb = b.fedcm_url || 'https://accounts.google.com/gsi/';
			...
			Mp(a.B, b.client_id, a.l);
			a.callback = b.callback;
			a.X = 'redirect' === b.ux_mode ? 'redirect' : 'popup';
			c = b.ui_mode;
			(void 0 !== c && Object.values(Xq).includes(c)) ||
				(c = _.lk() && !_.mk() ? 'bottom_sheet' : 'card');
			a.K = c;
			a.s =
				(b.prompt_parent
					? b.prompt_parent
					...
					: null) || document.body;
			a.Id = 9e4;
			a.eb = !1 !== b.cancel_on_tap_outside;
			...
			!c || (null != c && Br.test(c)) || (c = void 0);
			a.D = new wr(c, a.Hd, b.state_cookie_name);
			a.vc(b);
			c = {};
			...
			c.ui_mode = a.K;
			void 0 !== b.context &&
				Object.values(Wq).includes(b.context) &&
				(c.context = b.context);
		...
		Rr.prototype.vc = function () {};
		Rr.prototype.tc = function () {};
		var uq = function (a) {
				a.pc ||
					((a.pc = !0),
					_.C(
					...
					(a.ta = _.C(document, 'click', function () {
						a.eb && Ur(a, !1) && Vr(a, 'tap_outside');
					})));
			},
			Wr = function (a) {
				var b;
				(b = _.U('disable_fedcm') || (Hp() && !a.m)) ||
					(b = !(
						(!_.kk() || 0 <= _.ok(_.ik(), '118')) &&
						_.Da() &&
						!_.Ba() &&
						(_.xa() ? !_.va('Opera') : !_.w('OPR')) &&
						(_.jk() || (!_.lk() && !_.mk())) &&
				...
				if (b || (a.m && a.u.auto_select && !(121 <= _.id()))) return !1;
				b = a.u.client_id;
				if (
					_.U('enable_fedcm_idp_signin_status_origin_trial') &&
					!Zq.idpSigninStatus
				) {
					...
					Zq.idpSigninStatus = !0;
				}
				if (_.U('enable_fedcm_global_experiment')) return !0;
				if (_.U('enable_fedcm_global_control'))
					return _.x('In FedCM global control group'), !1;
				if (a.u.hosted_domain && !_.U('enable_fedcm_domain_hint') && !a.m)
					return !1;
				var d = !1 === a.m;
				b =
					(_.U('enable_fedcm_beta_launch') ||
						_.sk.enable_fedcm.includes(a.u.client_id)) &&
					a.m;
				c =
					_.U('enable_manual_fedcm_launch') &&
					(_.U('enable_fedcm_auto_reauthn') || !a.u.auto_select);
				if ((d = !d))
					!(b = b || c) &&
						(b = void 0 === a.m) &&
						((a =
							_.sk.enable_fedcm.includes(a.u.client_id) &&
							_.U('enable_fedcm_via_userid')),
						(b = _.U('enable_fedcm_idp_signin_status_origin_trial')),
						(b = a || b)),
						(d = b);
				return d;
			};
		Rr.prototype.pa = function (a, b) {
			b
				? this.callback
					? (_.x('Processing FedCM credential'),
					  ...
					  Xr({ data: { announcement: _.qj({}) } }),
					  this.callback.call(this, b),
					  _.x('FedCM response :' + JSON.stringify(b)),
					  'widget' === a && Yr(this, 'credential_returned'))
					: _.x('No callback provided')
				: _.x('FedCM credential is null');
		};
		Rr.prototype.Aa = function (a, b) {
			_.z('FedCM get() rejects with ' + b);
			'widget' === a && Vr(this, 'unknown_reason');
		};
		Rr.prototype.sa = function (a, b, c) {
			var d = this;
			b = Object.assign({}, this.g, b);
			var e =
				(b.prompt_parent_id || b.prompt_parent) &&
				'bottom_sheet' !== this.u.ui_mode;
			_.U('enable_fedcm_compliance_detection') && e && Vp('defaultPosition');
			e && !this.Z && (jq(), (this.Z = !0));
			Qr(this, b);
			b = 'bottom_sheet' === this.u.ui_mode ? 'bottomSheet' : 'card';
			_.U('enable_fedcm_compliance_detection') &&
				Gp() &&
				(Vp('oneTapNestedInIframe'),
				iq(this.g.client_id ? this.g.client_id : '', this.B, this.l));
			Gp() &&
				_.y(
			...
			_.U('enable_fedcm_csp_compliance_detection') &&
				hq(this.g.client_id ? this.g.client_id : '', this.B, this.l);
			window.location.href.startsWith('chrome-extension://')
				? (_.y('Attempted to start sign in flow inside chrome extension.'),
				  Sp(b, 'chromeExtension'))
				: (Ur(this, !0) && Yr(this, 'flow_restarted'),
				  _.U('enable_fedcm_compliance_detection') && a && Vp('uiEvents'),
				  a &&
						!this.jb &&
						(_.y(
				  ...
				  (this.gb = c),
				  this.u.client_id
						? _.U('unsupported_browser')
							? (_.G('One Tap is not supported in this User Agent.'),
							  this.i('browser_not_supported'),
							  _.Bi(this, 'prompt_display_failed', {
							...
							? (_.G(
							  ...
							  Sp(
									b,
									'cooldown',
									(yr(this.D).prompt_suppress_level || 0).toString()
							  ))
							: Wr(this)
							? ((this.J = !0),
							  kr(this.G, {
							...
							: Zr(this, function (f) {
									f && _.mi(_.N(f, 3))
										...
										? (_.jd(_.O(f, _.Cf, 2)),
										  ...
										  _.Bi(d, 'prompt_display_failed', {
												cause:
													'Error while checking for the credential status.',
										  }))
										: f && !_.mi(_.N(f, 3)) && _.pk() && d.oc
										? ((d.u.is_itp = !0),
										  $r(d),
										  as(d),
										  bs(d, !0),
		...
		var yq = function (a, b, c, d) {
					...
					d
						? d.wa
							...
							: ((b = {}),
							  ...
							  fs(a, b),
							  d.wc && d.wc(Object.assign({}, d.data)))
						: _.z('A button entry was not found for the given id.');
				}
			},
			fs = function (a, b) {
				Ur(a, !0) && (Yr(a, 'flow_restarted'), Tp('buttonFlowStarted'));
				b = Object.assign({}, a.g, b);
				Qr(a, b);
				_.U('enable_fedcm_button') && a.G.h && a.Gc
					? ((a.J = !0),
					  lr(a.G, {
							Ec: a.fb,
							Dc: a.Fa,
			...
			gs = function (a) {
				...
				if (_.U('enable_gis_oauth_button_flow_redirect')) {
					var b = {
						...
						redirect_uri: _.No(a.u.login_uri),
						response_mode: 'form_post',
					};
					var c = new _.Bo();
					c = _.Q(c, 1, a.u.origin);
					c = _.Q(c, 2, b.redirect_uri);
					c = _.R(c, 3, _.pi('btn'));
					c = _.Q(c, 4, a.u.g_csrf_token);
					c = _.Q(c, 5, a.u.as);
					c = _.Q(c, 6, a.u.client_id);
					c = _.R(c, 7, 2);
					c = er(c);
			...
			hs = function (a) {
				...
				if (_.U('enable_gis_oauth_button_flow_popup')) {
					...
					c = _.Q(c, 6, a.u.client_id);
					c = _.R(c, 7, 1);
					c = _.Q(c, 8, a.u.channel_id);
					c = er(c);
					b.gis_params = _.pd(c.g(), 4);
					if (_.tn(_.Pm(a.rc, b), Pr)) return;
					Op(new Pp('button', 'popup', 'clicked', 'oauthPopupNotOpened'));
				}
				_.tn(_.Pm(a.Ac, a.u), Pr) ||
					Op(new Pp('button', 'popup', 'clicked', 'popupNotOpened'));
			},
			Ur = function (a, b) {
				if (a.J)
					return (
							...
							? ((a = a.g),
							  ...
							  a.h
									? (a.h.abort(),
									  ...
									  (a.h = void 0),
									  (a = !0))
									: (_.x('No FedCM flow to abort. callId ' + a.g), (a = !1)))
				...
				gq(a.s)
					? ((b = a.v) && b.parentElement
					  ...
					  (b = !b))
					: (b = !Zp(a.s));
				if (b) return _.G('Failed to remove prompt iframe.'), !1;
				Lq(a);
				a.H = !0;
		...
		var bs = function (a, b, c) {
			...
			Yr = function (a, b) {
				if (a.j) {
					var c = a.j;
					a.j = void 0;
					var d = new ur('dismissed');
					d.i = b;
					c.call(a, d);
				}
			},
			is = function (a, b) {
				a.gb && a.gb.call(a, { type: b, message: void 0 });
			},
			Zr = function (a, b) {
				...
				sp(c, function (d) {
					d && 'null' !== d
						? ((d = ar(JSON.stringify(_.ni(d)))), b(d))
						: (_.z('Check credential status returns invalid response.'),
						  a.i('unknown_reason'),
						  _.Bi(a, 'network', { cause: 'invalid_response' }));
				});
			},
			$r = function (a) {
				var b = a.u,
				...
				a.H = !0;
				a.Cc(b);
				_.Ai(a, 'prompt_displayed');
			};
		Rr.prototype.Cc = function (a) {
			this.v = aq(this.s, a, 'bottom_sheet' === this.K);
		};
		var as = function (a) {
				'bottom_sheet' === a.K &&
					window.setTimeout(function () {
						Ur(a, !1) && Vr(a, 'auto_cancel');
					}, a.Id);
			},
			Tr = function (a, b) {
			...
			if (a.data && a.data.type)
				switch (
					...
					case 'response':
						...
						b &&
							(d
								? Yr(this, 'credential_returned')
								: (Vr(this, 'issuing_failed'), Tp('issuingFailed')),
							Lq(this));
						Xr(a);
						break;
					case 'activity':
						...
						if ((b = a.data.command))
							switch (b) {
								case 'close':
									a.data.suppress &&
										...
										(b.disable_auto_prompt =
											new Date().getTime() + 1e3 * vr[b.prompt_suppress_level]),
										Op(
											new Pp(
												'onetap',
												void 0,
										...
										zr(a, b));
									Ur(this, !0) && (Vr(this, 'user_cancel'), Lq(this));
									break;
								case 'resize':
									_.U('enable_fedcm_compliance_detection') &&
										!this.ib &&
									...
									a = a.data.height;
									if (cq(a)) {
										if (this.s !== document.body && gq(this.s))
											(b = this.v)
												? ((d = b.clientHeight),
												  b.parentElement &&
								...
								case 'start_auto_select':
									is(this, 'auto_select_started');
									break;
								case 'cancel_auto_select':
									Aq(this.D), is(this, 'auto_select_canceled');
							}
				}
		};
		var Xr = function (a) {
			a.data.announcement && fq(a.data.announcement);
		};
		Rr.prototype.revoke = function (a, b) {
			var c = { successful: !1 },
				d = this.u.client_id;
			d
				? _.U('enable_fedcm_revocation_client') &&
				  'IdentityCredential' in window &&
				  123 <= _.id()
					? window.IdentityCredential.disconnect({
							...
							function () {
								c.successful = !0;
								_.G("set result successful to: ' + " + !!c.successful);
								b && b(c);
							},
							function (e) {
					...
					: ((a = { client_id: d, hint: a }),
					  this.l && (a.as = this.l),
					  up(this.Ld, a, function (e) {
							if (e && 'null' !== e) {
								if (
									((e = cr(JSON.stringify(_.ni(e)))),
									(c.successful = !!_.mi(_.N(e, 3))),
									_.G('Revoke XHR status: ' + !!c.successful),
									!c.successful)
								)
									if (_.tf(e, _.Cf, 2)) {
										e = _.O(e, _.Cf, 2);
		...
		var sq = function (a) {
			...
			this.qc = !1;
			this.Y = !!this.h;
			this.hb = a && a.intermediate_iframe_close_callback;
			if (this.h && this.h)
				if ('string' === typeof this.h) {
					if (!vp(this.h)) throw Error('Ga');
				} else if (Array.isArray(this.h))
					for (a = 0; a < this.h.length; a++)
						if ('string' !== typeof this.h[a] || !vp(this.h[a]))
							throw Error('Ha');
		};
		_.M(sq, Rr);
		...
		sq.prototype.sa = function (a, b, c) {
			var d = this;
			this.Y && this.h
				? (_.x('Verifying parent origin.'),
				  _.bp(this.h, function () {
						_.Uo
							? _.Vo({ command: 'set_ui_mode', mode: d.K })
							: _.y(
									'Set ui mode command was not sent due to missing verified parent origin.'
							  );
						_.lp(!1);
						d.Bc = !1;
						Rr.prototype.sa.call(d, a, b, c);
				  }))
				: Rr.prototype.sa.call(this, a, b, c);
		};
		sq.prototype.Ga = function (a) {
			Rr.prototype.Ga.call(this, a);
				...
				switch (a.data.type) {
					...
					case 'command':
						switch (a.data.command) {
							case 'close':
								this.Bc ? _.jp(0) : this.hb ? (_.jp(0), this.hb()) : _.kp();
								break;
							case 'resize':
								a = a.data.height;
								'number' === typeof a && !isNaN(a) && 0 < a && _.jp(a);
								break;
							case 'cancel_protect_start':
								_.lp(!1);
								break;
		...
		sq.prototype.Cc = function (a) {
			this.v = aq(this.s, a, 'bottom_sheet' === this.K, this.Y);
		};
		...
		_.A('google.accounts.id.cancel', function () {
			var a = tq.__G_ID_CLIENT__;
			a && Ur(a, !0) && Yr(a, 'cancel_called');
		});
		_.A('google.accounts.id.disableAutoSelect', Bq);
		_.A('google.accounts.id.initialize', wq);
		_.A('google.accounts.id.prompt', xq);
		_.A('google.accounts.id.PromptMomentNotification', ur);
		_.A('google.accounts.id.renderButton', zq);
		_.A('google.accounts.id.revoke', function (a, b) {
			var c = tq.__G_ID_CLIENT__;
		...
		_.A('google.accounts.id.setLogLevel', function (a) {
			var b = tq.__G_ID_CLIENT__;
			b || (wq(), (b = tq.__G_ID_CLIENT__));
			a = a ? a.toLowerCase() : void 0;
			void 0 === a || 0 <= (0, _.La)(Oq, a)
				? Sr(b, a, !0)
				: (_.z(
		...
		var ls = function (a) {
					...
					window.addEventListener(
						...
						function (b) {
							try {
								...
								} else _.G('Message ignored. No event data.', 'OAUTH2_CLIENT');
							} catch (d) {
								_.G(
			...
			ns = function (a) {
				a.error_callback &&
					a.h &&
					!a.g &&
					(_.G('Starting popup timer.', 'OAUTH2_CLIENT'),
					(a.B = !1),
					(a.g = new _.Qm(500)),
					new _.Sm(a).L(a.g, 'tick', a.D),
					a.g.start());
			};
		ks.prototype.D = function () {
			_.x('Checking popup closed.', 'OAUTH2_CLIENT');
			!this.g ||
				this.B ||
				(this.h && !this.h.closed) ||
				(_.G('Popup window closed.', 'OAUTH2_CLIENT'),
				this.error_callback &&
					this.error_callback(new Hq('Popup window closed', 'popup_closed')),
				_.Rm(this.g),
				(this.h = this.g = void 0));
		};
		var os = new _.vn('g_auth_code_window'),
			ps = function (a) {
				ks.call(this, 'code', a);
				...
				this.X = a;
				_.G('Instantiated.', 'CODE_CLIENT');
			};
		_.M(ps, ks);
		ps.prototype.i = function (a) {
			_.G('Handling response. ' + JSON.stringify(a), 'CODE_CLIENT');
			ks.prototype.i.call(this, a);
			this.callback && this.callback.call(this, a);
		};
		ps.prototype.requestCode = function () {
			var a = this.o;
			'redirect' === this.X
				? (_.G('Starting redirect flow.', 'CODE_CLIENT'),
				  _.Nm(window.location, _.$a(Gq(this.l, this.m, a))))
				: (_.G('Starting popup flow.', 'CODE_CLIENT'),
				  ls(this),
				  ms(this, a),
				  (this.h = _.tn(Gq(this.l, this.m, a), os)),
				  !this.h && this.error_callback
						? this.error_callback(
								new Hq('Failed to open popup window', 'popup_failed_to_open')
						  )
						: ns(this));
		};
		var qs = new _.vn('g_auth_token_window'),
			rs = window,
			ss = function (a) {
				ks.call(this, 'token', a);
				this.callback = a.callback;
				_.G('Instantiated.', 'TOKEN_CLIENT');
			};
		_.M(ss, ks);
		ss.prototype.i = function (a) {
			_.G('Handling response. ' + JSON.stringify(a), 'TOKEN_CLIENT');
			ks.prototype.i.call(this, a);
			_.G('Trying to set gapi client token.', 'TOKEN_CLIENT');
			if (a.access_token)
				if (rs.gapi && rs.gapi.client && rs.gapi.client.setToken)
					try {
						rs.gapi.client.setToken.call(this, a);
					} catch (b) {
		...
		ss.prototype.requestAccessToken = function (a) {
			var b = this.o;
			a = a || {};
			...
			_.G('Starting popup flow.', 'TOKEN_CLIENT');
			ls(this);
			ms(this, b);
			this.h = _.tn(Gq(this.l, this.m, b), qs);
			!this.h && this.error_callback
				? this.error_callback(
						new Hq('Failed to open popup window', 'popup_failed_to_open')
				  )
		...
		_.A('google.accounts.oauth2.GoogleIdentityServicesError', Hq);
		...
		_.A('google.accounts.oauth2.CodeClient', ps);
		_.A('google.accounts.oauth2.initTokenClient', function (a) {
			return new ss(a);
		});
		_.A('google.accounts.oauth2.TokenClient', ss);
		_.A('google.accounts.oauth2.hasGrantedAllScopes', function (a) {
			var b = Rp.apply(1, arguments),
				c = Kq(a);
			return c && c.length
				? (b = Jq.apply(null, Qp(b))) && b.length
					? (0, _.vb)(b, function (d) {
							return 0 <= (0, _.La)(c, d);
					  })
					: !1
		...
		_.A('google.accounts.oauth2.revoke', function (a, b) {
			...
			tp('https://oauth2.googleapis.com/revoke', a, !1, function (c) {
				b &&
					(_.G('callback with response: ' + c),
					(c = c ? JSON.parse(c) : {}),
