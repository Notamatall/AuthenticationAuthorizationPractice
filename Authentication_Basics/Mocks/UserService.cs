...
namespace Authentication_Basics.Mocks
{
    public class User
    {
    ...
    public class UserService : IUserService
    {
        ...
        {
            return await Task.Run(() => WithoutPasswords(users));
        }

        public static IEnumerable<User> WithoutPasswords(IEnumerable<User> users)
        {
